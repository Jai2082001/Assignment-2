  ...
  handleInput(sInput) {
    ...
    switch (this.stateCur) {
      case OrderState.WELCOMING:
        ...
        aReturn.push(
          "What would you like to order? (Burger, Sandwich, or Pasta)"
        );
        break;
      ...
      case OrderState.ITEM_SELECTION:
        ...
        if (
          ...
          aReturn.push(
            "Sorry, we didn't get it Please select from the following."
          );
          aReturn.push("Burger, Sandwich, or Pasta");
          this.stateCur = OrderState.ITEM_SELECTION;
        }
        break;
      ...
      case OrderState.DRINKSCHECK:
        if (sInput.toLowerCase() == "yes") {
          ...
          aReturn.push("Which drink do you like? (Coke, Sprite, Slushie)");
      ...
      case OrderState.DRINKS:
        sInput = sInput.toLowerCase();
        if (sInput === "coke" || sInput === "sprite" || sInput === "slushie") {
          this.stateCur = OrderState.COOKIES;
          this.sDrinks = sInput;
          aReturn.push("Would you like dipping with that? (Yes or No)");
        } else {
          aReturn.push("Please enter from the given options.");
          aReturn.push("Coke, Beer or Pepsi");
          this.stateCur = OrderState.DRINKS;
        }
        break;
      ...
      case OrderState.COOKIES:
        if (sInput.toLowerCase() == "yes") {
          ...
          aReturn.push("Please enter Yes or No for the dipping");
          this.stateCur = OrderState.COOKIES;
        }
        break;
      ...
      case OrderState.SUMMARY:
        if (sInput.toLowerCase() == "yes") {
          ...
          aReturn.push(
            "What would you like to order? (Burger, Pasta, Sandwich)"
          );
          this.stateCur = OrderState.ITEM_SELECTION;
        } else if (sInput.toLowerCase() == "no") {
          this.generateOrderSummary();
